...
<div class="wrapper">
    <div class="container-fluid d-flex justify-content-center">      
        <div class="jumbotron">
                <h1 class="display-4">Welcome to our Under Water Hotel!</h1>
    ...
    <div class="container justify-content-center">
        <div class="row justify-content-center">
            <div class="frontpage-img text-center">
                <img src="Pics/summerypic.jpg" class="rounded text-center" alt="Summery Picture" width="335" height="335">
            </div>
        </div>
    </div>
</div>
